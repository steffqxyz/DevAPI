package org.twindev.devAPI.menus.builder;
...
import org.twindev.devAPI.utils.ListUtils;
import org.twindev.devAPI.utils.SlotBuilder;
...
public class ItemBuilder {
    ...
    public ItemBuilder(Config config, String path) {
    ...
    public ItemStack build(Player player) {
        ...
        if (paginated) {
            pdc.set(
                    DevAPI.getNamespacedKeyPaginated(),
